...
versions such as `0.3.3` and immutable-by-policy Git tags such as `v0.3.3`.
...
```text
https://raw.githubusercontent.com/algomim/release/v0.3.3/codex/install.ps1
https://raw.githubusercontent.com/algomim/release/v0.3.3/claude-code/install.sh
```
...
manifest.json
SHA256SUMS
algomim-codex-windows-v0.3.3.zip
algomim-codex-posix-v0.3.3.tar.gz
algomim-claude-code-windows-v0.3.3.zip
algomim-claude-code-posix-v0.3.3.tar.gz
algomim-cli-windows-v0.3.3.zip
algomim-cli-posix-v0.3.3.tar.gz
```
...
Users upgrading from v0.3.2 can use `algomim update claude`. Because v0.3.1
shipped an older CLI repair bundle, those users run the current tag-pinned
installer once. The installer reuses the existing credential while refreshing
both the active Claude Code integration and its CLI repair bundle.

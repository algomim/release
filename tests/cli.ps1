...
try {
  ...
  Assert-Equal "0.3.1" ([string] $cliState.version) "CLI state records the release version"
  Assert-Equal "v0.3.1" ([string] $cliState.releaseTag) "CLI state records the immutable tag"
  ...
  Assert-True ($versionOutput.Contains("Algomim CLI 0.3.1 (v0.3.1)")) "version reports CLI version"

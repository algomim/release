...
try {
  ...
  Assert-Equal "0.3.8" ([string] $cliState.version) "CLI state records the release version"
  Assert-Equal "v0.3.8" ([string] $cliState.releaseTag) "CLI state records the immutable tag"
  ...
  Assert-True ($versionOutput.Contains("Algomim CLI 0.3.8 (v0.3.8)")) "version reports CLI version"

...
try {
  ...
  Assert-Equal "0.3.3" ([string] $cliState.version) "CLI state records the release version"
  Assert-Equal "v0.3.3" ([string] $cliState.releaseTag) "CLI state records the immutable tag"
  ...
  Assert-True ($versionOutput.Contains("Algomim CLI 0.3.3 (v0.3.3)")) "version reports CLI version"
